" Name:       paragold.vim
" Version:    0.1.0
" Maintainer: github.com/tobleron
" License:    The MIT License (MIT)
"
" paragold-ora.vim is a presumed enhancement based on paragold.vim (based one paramount.vim) which is a minimal colorscheme for Vim that only puts emphasis on the paramount.
"
...
let g:colors_name='paragold-ora'
...
if &background == "dark"
  ...
  let s:norm_subtle     = s:orange
  let s:purple          = s:gold_yellow
  let s:cyan            = s:light_cyan
  let s:green           = s:light_green
  let s:red             = s:dark_red
  let s:visual          = s:gold_yellow
